...
public class TripSheetFragment extends Fragment {
    private static final String TAG = TripSheetFragment.class.getSimpleName();
    ...
    private TripSheetAdapter expenseAdapter;
    ...
    public static TripSheetFragment newInstance() {
        return new TripSheetFragment();
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        expenseAdapter = new TripSheetAdapter(getActivity(), expenses);
        setupToolbar();
        setupRecyclerView();
        setupSwipeToRefresh();
    }
    ...
    private MemberFilterFragment.MemberFilterListener memberFilterListener = new MemberFilterFragment.MemberFilterListener() {
        ...
        public void onFinishMemberFilterDialog(Member member) {
            if (!isMemberFiltered ||
                (TripSheetFragment.this.member != null && member != null && TripSheetFragment.this.member.getId().equals(member.getId()))) {
                isMemberFiltered = !isMemberFiltered;
            }

            TripSheetFragment.this.member = member;
    ...
    private DateFilterFragment.DateFilterListener dateFilterListener = new DateFilterFragment.DateFilterListener() {
        ...
        public void onFinishDateFilterDialog(Date startDate, Date endDate) {
            ...
            TripSheetFragment.this.startDate = startDate;
            TripSheetFragment.this.endDate = endDate;
            invalidateViews();
        }
    };
    ...
    private CategoryFilterFragment.CategoryFilterListener categoryFilterListener = new CategoryFilterFragment.CategoryFilterListener() {
        ...
        public void onFinishCategoryFilterDialog(Category category) {
            if (!isCategoryFiltered ||
                ((TripSheetFragment.this.category == null && category == null) || (TripSheetFragment.this.category != null
                    && category != null && TripSheetFragment.this.category.getId().equals(category.getId())))) {
                isCategoryFiltered = !isCategoryFiltered;
            }
            TripSheetFragment.this.category = category;
