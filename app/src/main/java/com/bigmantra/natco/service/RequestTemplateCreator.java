...
public class RequestTemplateCreator {
    ...
    private static final String BASE_URL = "https://natco.herokuapp.com/";
    ...
    public static com.bigmantra.natco.service.RequestTemplate updatePassword(String userId, String password) {
        String url = BASE_URL + "users/" + userId;
        Map<String, String> params = new HashMap<>();

        params.put(User.PASSWORD_JSON_KEY, password);

        return new com.bigmantra.natco.service.RequestTemplate(PUT, url, params);
    }
...
//        String time2 = timezoneFormat2.format(busDailySummary.getSummaryDate());
    ...
    public static RequestTemplate approveBusDailySummary(String busDailySummaryId) {
        String url = BASE_URL + "busdailysummaries/" + busDailySummaryId + "/approval";
        Map<String, String> params = new HashMap<>();
